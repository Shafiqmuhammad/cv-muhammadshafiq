...
//   return (
//     // <div className="min-h-screen bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 py-12 px-4 overflow-x-hidden">
//     <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-100 py-12 px-4 overflow-x-hidden">
//       <motion.button
//         onClick={downloadPDF}
//         className="fixed top-6 right-6 z-50 glass-card px-6 py-3 rounded-full flex items-center gap-2 text-white font-semibold hover:bg-red-500/30 transition-all duration-300 hover:scale-105"
...
//                 <div className="absolute inset-0 bg-linear-to-r from-red-500 to-pink-500 rounded-full blur-2xl opacity-50 animate-pulse" />
//                 <Image
//                 width={222}
//                 height={222}
//                   src="/shafiq.png"
//                   alt="Muhammad Shafiq"
//                   className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-white/20 relative z-10"
//                 />
//               </div>
...
//                 </motion.h1>
//                 <motion.p
//                   className="text-xl md:text-2xl text-red-400 font-semibold mb-2"
//                   initial={{ x: -50, opacity: 0 }}
//                   animate={{ x: 0, opacity: 1 }}
...
//               <p className="text-red-400 text-sm mb-3">2023 – Present</p>
...
//               <p className="text-red-400 text-sm mb-3">2021 – 2023</p>
//               <ul className="text-gray-300 space-y-2 list-disc list-inside">
...
//               <p className="text-red-400 text-sm mb-3">2017 – 2019</p>
//               <ul className="text-gray-300 space-y-2 list-disc list-inside">
...
//               <h3 className="text-lg font-bold text-red-400 mb-3">AI & Machine Learning</h3>
...
//             <div className="skill-category">
//               <h3 className="text-lg font-bold text-red-400 mb-3">Web3 & Blockchain</h3>
//               <div className="flex flex-wrap gap-2">
...
//             <div className="skill-category">
//               <h3 className="text-lg font-bold text-red-400 mb-3">Full-Stack Development</h3>
//               <div className="flex flex-wrap gap-2">
...
//             <div className="skill-category">
//               <h3 className="text-lg font-bold text-red-400 mb-3">Immersive Tech</h3>
//               <div className="flex flex-wrap gap-2">
...
//               <p className="text-gray-300 text-sm">Multi-agent orchestration using OpenAI Agent SDK + Anthropic MCP</p>
//             </div>

//             <div className="project-card">
//               <h3 className="text-lg font-bold text-white mb-2">DeFi Dashboard</h3>
//               <p className="text-gray-300 text-sm">Real-time Ethereum analytics dashboard</p>
//             </div>

//             <div className="project-card">
//               <h3 className="text-lg font-bold text-white mb-2">NFT Marketplace</h3>
//               <p className="text-gray-300 text-sm">Decentralized platform for minting & auctions</p>
//             </div>

//             <div className="project-card">
//               <h3 className="text-lg font-bold text-white mb-2">Metaverse Experience</h3>
//               <p className="text-gray-300 text-sm">Immersive WebXR space with AI NPCs & wallet integration</p>
//             </div>
//           </div>
//         </motion.div>
...
//             <p className="text-red-400 mb-3">University of the People</p>
//             <p className="text-gray-300 text-sm font-semibold mb-2">Relevant Coursework:</p>
//             <div className="flex flex-wrap gap-2">
...
//                width={20}
//                 height={20}
//                 src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=https://muhammad-shafiq00786.vercel.app/"
...
//     bgColor=""
//     fgColor="#FFFFFF"
//     className="rounded-xl border border-white/20 p-1"
//   />
//   {/* <p className="text-xs text-gray-400 mt-2">Scan to view portfolio</p> */}
// </div>
